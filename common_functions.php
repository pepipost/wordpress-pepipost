...
<div class="w-logo  with_transparent">
	<a class="w-logo-link" href="http://www.pepipost.com/">
		<span class="w-logo-img">
			<img class="for_transparent" src="<?php echo plugins_url( 'images/Pepipost-Png1.png', __FILE__ ) ?>" alt="Pepipost: Cloud Based Triggered and Transactional Email Service">
		</span>
	</a>
